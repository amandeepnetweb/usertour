...
@ArgsType()
export class QueryEventsInput extends PickType(Events, ['projectId'], ArgsType) {}

@InputType()
export class InitEventInput extends PickType(Events, ['displayName', 'codeName'], InputType) {}
