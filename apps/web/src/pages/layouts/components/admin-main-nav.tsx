...
const commonIconStyles =
  "!h-[18px] !w-[18px] text-primary-modified dark:text-foreground/[60%]";
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          className={cn(
            commonButtonStyles,
            isActive ? "bg-background shadow border-input" : ""
          )}
          {...props}
        >
          <Icon
            className={cn(commonIconStyles, isActive ? "text-primary" : "")}
          />
        </Button>
      </TooltipTrigger>
          ...
          className={cn(
            ...
            (contentType == "trackers" && nav.routeIds.includes(contentType)) ||
              (contentType != "trackers" &&
                matches &&
                nav.routeIds.includes(matches[0].id))
              ? ""
