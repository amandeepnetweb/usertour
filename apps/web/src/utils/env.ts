...
export const posthogKey = import.meta.env.VITE_POSTHOG_KEY || window?.ENV?.POSTHOG_KEY;

export const posthogHost = import.meta.env.VITE_POSTHOG_HOST || window?.ENV?.POSTHOG_HOST;
