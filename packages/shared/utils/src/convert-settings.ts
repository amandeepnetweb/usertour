...
export const convertSettings = (settings: ThemeTypesSetting) => {
  ...
  if (settings.buttons.primary.backgroundColor.hover == "Auto") {
    data.buttons.primary.backgroundColor.hover = settings.brandColor
      .autoHover as string;
  }
  if (settings.buttons.primary.backgroundColor.active == "Auto") {
    data.buttons.primary.backgroundColor.active = settings.brandColor
      .autoActive as string;
  }
  ...
  if (settings.buttons.primary.border.color.hover == "Auto") {
    data.buttons.primary.border.color.hover = settings.brandColor
      .autoHover as string;
  }
  if (settings.buttons.primary.border.color.active == "Auto") {
    data.buttons.primary.border.color.active = settings.brandColor
      .autoActive as string;
  }
  ...
  if (settings.buttons.secondary.backgroundColor.hover == "Auto") {
    data.buttons.secondary.backgroundColor.hover = settings.mainColor
      .autoHover as string;
  }
  if (settings.buttons.secondary.backgroundColor.active == "Auto") {
    data.buttons.secondary.backgroundColor.active = settings.mainColor
      .autoActive as string;
  }
  ...
  if (settings.checklistLauncher?.color?.hover == "Auto") {
    data.checklistLauncher.color.hover = settings.brandColor
      .autoHover as string;
  }
  if (settings.checklistLauncher?.color?.active == "Auto") {
    data.checklistLauncher.color.active = settings.brandColor
      .autoActive as string;
  }
...
export const convertToCssVars = (
  ...
  const cssMapping: any = {
    ...
    "--usertour-widget-popper-border-radius":
      settings.border.borderRadius + "px",
    ...
    "--usertour-primary-foreground-hover":
      settings.buttons.primary.textColor.hover,
    "--usertour-primary-foreground-active":
      settings.buttons.primary.textColor.active,
    "--usertour-primary-border-width": settings.buttons.primary.border.enabled
      ? settings.buttons.primary.border.borderWidth + "px"
      : "0px",
    "--usertour-primary-border-color":
      settings.buttons.primary.border.color.color,
    "--usertour-primary-border-hover":
      settings.buttons.primary.border.color.hover,
    "--usertour-primary-border-active":
      settings.buttons.primary.border.color.active,
    "--usertour-primary-font-weight": settings.buttons.primary.fontWeight,
    "--usertour-secondary":
      settings.buttons.secondary.backgroundColor.background,
    "--usertour-secondary-hover":
      settings.buttons.secondary.backgroundColor.hover,
    "--usertour-secondary-active":
      settings.buttons.secondary.backgroundColor.active,
    "--usertour-secondary-foreground":
      settings.buttons.secondary.textColor.color,
    "--usertour-secondary-foreground-hover":
      settings.buttons.secondary.textColor.hover,
    "--usertour-secondary-foreground-active":
      settings.buttons.secondary.textColor.active,
    "--usertour-secondary-border-width": settings.buttons.secondary.border
      .enabled
      ? settings.buttons.secondary.border.borderWidth + "px"
      : "0px",
    "--usertour-secondary-border-color":
      settings.buttons.secondary.border.color.color,
    "--usertour-secondary-border-hover":
      settings.buttons.secondary.border.color.hover,
    "--usertour-secondary-border-active":
      settings.buttons.secondary.border.color.active,
    ...
    "--usertour-backdrop-highlight-color-rgb": hexToRGBStr(
      settings.backdrop.highlight.color
    ),
    "--usertour-backdrop-highlight-opacity":
      settings.backdrop.highlight.opacity / 100,
    "--usertour-backdrop-highlight-radius":
      settings.backdrop.highlight.radius + "px",
    "--usertour-backdrop-highlight-spread":
      settings.backdrop.highlight.spread + "px",
    ...
    "--usertour-widget-launcher-icon-hover-color":
      settings.launcherIcon.color.hover,
    "--usertour-widget-launcher-icon-active-color":
      settings.launcherIcon.color.active,
    ...
    "--usertour-widget-launcher-icon-opacity":
      settings.launcherIcon.opacity / 100,
    "--usertour-widget-popper-padding-top": "2px",
    "--usertour-widget-popper-padding-bottom": "2px",
    "--usertour-checklist-trigger-active-background-color":
      settings.checklistLauncher.color.active,
    "--usertour-checklist-trigger-background-color":
      settings.checklistLauncher.color.background,
    "--usertour-checklist-trigger-border-radius":
      settings.checklistLauncher.borderRadius + "px",
    "--usertour-checklist-trigger-counter-background-color":
      settings.checklistLauncher.counter.background,
    "--usertour-checklist-trigger-counter-font-color":
      settings.checklistLauncher.counter.color,
    "--usertour-checklist-trigger-font-color-rgb":
      settings.checklistLauncher.color.color,
    "--usertour-checklist-trigger-font-color":
      settings.checklistLauncher.color.color,
    "--usertour-checklist-trigger-font-weight":
      settings.checklistLauncher.fontWeight,
    "--usertour-checkmark-background-color": settings.checklist.checkmarkColor,
    "--usertour-checklist-trigger-height":
      settings.checklistLauncher.height + "px",
    "--usertour-checklist-trigger-hover-background-color":
      settings.checklistLauncher.color.hover,
