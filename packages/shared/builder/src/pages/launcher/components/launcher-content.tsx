...
import { LauncherContent } from "@usertour-ui/sdk";
import {
...
export const LauncherContentMain = forwardRef<
  HTMLDivElement,
...
>((props: LauncherContentProps, ref) => {
  ...
  const triggerReference = useMemo(
    () =>
      data.tooltip.reference === LauncherPositionType.TARGET
        ? triggerRef
        : launcherRef,
  ...
  const isTooltipOpen =
    data.behavior.actionType === LauncherActionType.SHOW_TOOLTIP;
