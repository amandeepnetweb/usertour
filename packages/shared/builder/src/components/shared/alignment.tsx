...
const AlignmentContext =
  createContext<AlignmentContextProps>(defaultContextValue);
...
const Circle = ({ side, align, onClick }: CircleProps) => {
  ...
  useEffect(() => {
    const isActive =
      type === "fixed" && currentAlign === align && currentSide === side;
    setClassName(
      cn("sdk-alignment", isActive ? circleHoveredClassName : circleClassName)
    );
        ...
        <div className="flex flex-col bg-background-700 p-3.5 rounded-lg">
          ...
          <div className="items-center flex justify-between">
            ...
            <div className="items-center bg-background-400 rounded flex grow h-20 justify-center relative w-full m-3 px-3 py-6">
              ...
              <div
                className={cn(
                  "absolute border-transparent border-solid border-[6px]",
                  arrowCls
                )}
              ></div>
            </div>
