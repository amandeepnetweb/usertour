...
export const NumberedListElementSerialize = (
  props: NumberedListElementSerializeType
) => {
  const { className, children } = props;
  return (
    <ol className={cn("list-decimal list-inside", className)}>{children}</ol>
  );
};
