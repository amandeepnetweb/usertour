...
export const ContentActionsConditionIcon = forwardRef<
  HTMLDivElement,
  TemplateSharedProps
>((props, ref) => {
  ...
  return (
    <div
      className={cn(
        "flex-none px-2 inline-flex items-center justify-center",
        className
      )}
      ref={ref}
    >
...
export const ActionsConditionRightContent = forwardRef<
  HTMLDivElement,
  TemplateSharedProps
>((props, ref) => {
  const { children, className } = props;
