...
export const H2Icon = forwardRef(
...
export const ListOrderIcon = forwardRef(
  ({ width = 15, height = 15 }: SvgProps, forwardedRef: any) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const WaitIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ ...props }, forwardedRef) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  ({ ...props }, forwardedRef) => {
    return (
      <svg
        ...
        ref={forwardedRef}
      >
        <path d="M22 20V7L20 3H4L2 7.00353V20C2 20.5523 2.44772 21 3 21H21C21.5523 21 22 20.5523 22 20ZM5.23582 5H18.7638L19.7638 7H4.23682L5.23582 5ZM9 11H15V13H9V11Z"></path>
      </svg>
    );
  }
);
  ...
  ({ ...props }, forwardedRef) => {
    return (
      <svg
        ...
        ref={forwardedRef}
      >
        <rect x="0" y="0" width="16" height="16" fill="#FFFFFF"></rect>
        <path
  ...
  ({ ...props }, forwardedRef) => {
    return (
      <svg
        ...
        ref={forwardedRef}
      >
        <path d="M16 10.06L16 2.74C16 0 13 0 13 0L3 0C1.37 0 0.62 0.81 0.62 0.81C0 1.49 0 2.74 0 2.74L0 9.37L0 10.06C0 12.8 3 12.8 3 12.8C4 12.8 4 13 4 13L4.5 16L8.5 13C9 12.8 10.73 12.8 10.73 12.8C12.45 12.8 13 12.8 13 12.8C16 12.8 16 10.06 16 10.06Z"></path>
      </svg>
    );
  }
);

export const NpsIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ ...props }, forwardedRef) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const IndeterminateCircleIcon = React.forwardRef<
  SVGSVGElement,
  IconProps
>(({ ...props }, forwardedRef) => {
  return (
    <svg
      ...
      ref={forwardedRef}
    >
      <path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM7 11V13H17V11H7Z"></path>
    </svg>
  );
});
